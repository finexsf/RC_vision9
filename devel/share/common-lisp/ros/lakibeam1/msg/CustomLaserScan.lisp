...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<CustomLaserScan>)))
  ...
  "7f8198cf97edc781dfaca87a453b9184")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'CustomLaserScan)))
  "Returns md5sum for a message object of type 'CustomLaserScan"
  "7f8198cf97edc781dfaca87a453b9184")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<CustomLaserScan>)))
  ...
  (cl:format cl:nil "Header Header~%float32 angle_min~%float32 angle_max~%float32 angle_increment~%float32 scan_time~%float32 range_min~%float32 range_max~%float32[] ranges~%float32[] intensities~%float32[] distances~%float32[] angles~%float32[] x_coords~%float32[] y_coords~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'CustomLaserScan)))
  "Returns full string definition for message of type 'CustomLaserScan"
  (cl:format cl:nil "Header Header~%float32 angle_min~%float32 angle_max~%float32 angle_increment~%float32 scan_time~%float32 range_min~%float32 range_max~%float32[] ranges~%float32[] intensities~%float32[] distances~%float32[] angles~%float32[] x_coords~%float32[] y_coords~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
