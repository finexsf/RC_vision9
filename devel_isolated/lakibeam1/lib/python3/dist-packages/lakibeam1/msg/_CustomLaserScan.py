...
class CustomLaserScan(genpy.Message):
  _md5sum = "6df6ab43231c4a4d8b1333313d831354"
...
string frame_id
"""
  __slots__ = ['header','angle_min','angle_max','angle_increment','time_increment','scan_time','range_min','range_max','ranges','intensities','distances','angles','x_coords','y_coords']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,angle_min,angle_max,angle_increment,time_increment,scan_time,range_min,range_max,ranges,intensities,distances,angles,x_coords,y_coords
